...
namespace NodeCanvas.Editor{
    ...
    public static class BlackboardEditor {
		...
		public static void ShowVariables(IBlackboard bb, UnityEngine.Object contextParent){
			...
			var usedVariableNames = Graph.currentSelection != null? Graph.GetUsedParameterNamesOfTarget(Graph.currentSelection) : new List<string>();
			//The actual variables reorderable list
			EditorUtils.ReorderableList(tempList, (i, picked) =>
			{
				...
				if (missingVariableType == null){
					...
					if (isUsed){
						...
						highRect.xMax -= 2;
						highRect.yMax -= 4;
						GUI.Box(highRect, "", (GUIStyle)"LightmapEditorSelectedHighlight");
					}
		...
		static object VariableField(Variable data, UnityEngine.Object context, GUILayoutOption[] layoutOptions){
			...
			if (t == typeof(System.Type)){
				return EditorUtils.Popup<System.Type>("", (System.Type)o, UserTypePrefs.GetPreferedTypesList(true), layoutOptions );
			}
